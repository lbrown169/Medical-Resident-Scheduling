...
public class RotationConverter(RotationTypeConverter rotationTypeConverter)
{
    ...
    public RotationResponse CreateRotationResponseFromModel(Rotation rotation)
    {
        return new()
        {
            ...
            AcademicMonthIndex = (int)rotation.AcademicMonthIndex,
    ...
    {
        MonthOfYear academicMonthIndex = (MonthOfYear)calendarMonthIndex.ToAcademicIndex();
        ...
        return new()
        {
            ...
            AcademicMonthIndex = academicMonthIndex,
