        ...
        try
        {
            ...
            foreach (SwapRequest swap in pendingSwaps)
            {
                ...
                dashboardData.RecentActivity.Add(new DashboardDataResponse.Activity
                {
                    ...
                    Date = DateTime.SpecifyKind(swap.CreatedAt, DateTimeKind.Utc).ToLocalTime().ToString("MM/dd/yyyy")
                });
            }
            ...
            foreach (SwapRequest swap in respondedSwaps)
            {
                ...
                dashboardData.RecentActivity.Add(new DashboardDataResponse.Activity
                {
                    ...
                    Type = swap.Status == RequestStatus.Approved
                        ...
                        : "swap_denied",
                    Message = message,
                    Date = DateTime.SpecifyKind(swap.UpdatedAt, DateTimeKind.Utc).ToLocalTime().ToString("MM/dd/yyyy")
                });
            }
